...
## Latest: fixed-main before/after rebase — 2026-09-17
...
baseline. No fields were ignored or waived. All six common upstream field
differences and the two additional Hybrid/Mamba differences recorded below are gone.
...
## Historical runs before the rebase

The following results remain as attribution evidence. Their 37 mismatches are
superseded by the fixed-base rerun above, not converted retroactively into passes.
